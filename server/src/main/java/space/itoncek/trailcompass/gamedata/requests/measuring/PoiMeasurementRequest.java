...
public class PoiMeasurementRequest implements Request {
	private static final Logger l = LoggerFactory.getLogger(PoiMeasurementRequest.class);
	private final FeatureLibrary flib;
	private final TrailServer server;
	private final String query;

	public PoiMeasurementRequest(FeatureLibrary flib, TrailServer server, String query) {
		this.flib = flib;
		this.server = server;
		this.query = query;
	}
	...
	@Override
	public String getID() {
		return "space.itoncek.trailcompass.gamedata.requests.measuring.PoiMeasurementRequest."+query;
	}
