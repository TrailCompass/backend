...
public class DatabasePlayer {
	...
	@OneToMany(targetEntity = PlayedCurse.class, mappedBy = "hider")
	List<PlayedCurse> playedCurses;
	@OneToMany(targetEntity = FreeQuestionToken.class, mappedBy = "hider")
	List<FreeQuestionToken> freeQuestions;
